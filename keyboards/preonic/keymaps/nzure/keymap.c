...
[_LOWER] = LAYOUT_preonic_grid(
	...
	_______, KC_HOME, KC_UP,   KC_END,   S(KC_LBRC), S(KC_LBRC), _______, _______, KC_F7,  KC_F8,   KC_F9,   KC_BACKSLASH,
...
[_RAISE] = LAYOUT_preonic_grid(
	_______, KC_F1,   KC_F2,   KC_F3,    KC_F4,      KC_F5,      KC_F6,   KC_F7,   KC_F8, KC_F9,   KC_F10,  _______,
	_______, KC_HOME, KC_UP,   KC_END,   S(KC_LBRC), S(KC_LBRC), _______, _______, KC_P7, KC_P8,   KC_P9,   KC_BACKSLASH,
	_______, KC_LEFT, KC_DOWN, KC_RIGHT, S(KC_9),    S(KC_0),    _______, _______, KC_P4, KC_P5,   KC_P6,   _______,
	_______, KC_MPRV, KC_MPLY, KC_MNXT,  KC_LBRC,    KC_RBRC,    _______, _______, KC_P1, KC_P2,   KC_P3,   _______,
...
[_ADJUST] = LAYOUT_preonic_grid(
	...
	_______, QWERTY,  WORKMAN, _______, _______, _______, _______, _______, _______, _______, QK_BOOT, KC_DEL,
